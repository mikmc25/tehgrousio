...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-h-ougm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-h-ougm.containers.anotherwebservice.com/
...
```
git clone git@github.com:mikmc25/tehgrousio.git
cd container-h-ougm
```
...
```
docker attach container-h-ougm
```
